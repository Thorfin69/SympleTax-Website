          ...
          <div className="max-w-[1330px] mx-auto px-[25px] lg:px-[70px] text-center">
            ...
            <div className="flex items-center justify-center gap-[20px] flex-wrap">
              <Link
                ...
                className="inline-flex items-center gap-[12px] bg-[#00A4A4] hover:bg-[#007a7a] text-white font-['DM_Sans'] font-bold rounded-full hover:scale-[1.02] transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#00A4A4] focus-visible:ring-offset-2"
