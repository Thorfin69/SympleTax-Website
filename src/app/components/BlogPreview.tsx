    ...
    <section className="bg-white py-[120px]">
      <div className="max-w-[1330px] mx-auto px-[70px]">
        ...
        <div className="flex items-end justify-between mb-[52px]">
          ...
          <Link
            to="/resources"
            className="font-['Inter'] font-medium text-[#2c3e50] border-b border-[#2c3e50]/30 pb-0.5 hover:border-[#2c3e50] transition-colors shrink-0"
        ...
        <div className="flex gap-[24px] items-stretch">
          ...
          {POSTS.map((post, idx) => (
            <motion.article
              ...
              className="flex-1 min-w-0 bg-[#f7f7f7] rounded-[12px] overflow-hidden flex flex-col group"
            >
              ...
              <div className="flex flex-col flex-1 justify-between p-[28px] gap-[20px]">
                <div className="flex flex-col gap-[12px]">
                  <h3
                    className="font-['Inter'] font-bold text-[#2c3e50] leading-[1.25]"
                    style={{ fontSize: "22px", letterSpacing: "-0.6px" }}
                  >
                    {post.title}
                  </h3>
                  <p
                    className="font-['Inter'] font-normal text-[#636363] leading-[1.65]"
                ...
                <Link to="/resources" className="flex items-center justify-between group/cta">
                  <span
                    className="font-['Inter'] font-semibold text-[#2c3e50] group-hover/cta:text-[#00838F] transition-colors"
                    style={{ fontSize: "16px", letterSpacing: "-0.3px" }}
                  >
                    Read More
                  </span>
                  <div className="w-[48px] h-[48px] rounded-full bg-[#2c3e50] group-hover/cta:bg-[#00838F] transition-colors flex items-center justify-center text-white shrink-0">
                    <ArrowIcon />
                  </div>
                </Link>
              </div>
          ...
          >
            <Link to="/resources" className="block h-full">
              <div className="bg-[#2c3e50] rounded-[12px] h-full flex flex-col justify-between p-[36px] relative overflow-hidden group">

                {/* Top content */}
                <div className="flex flex-col gap-[20px]">
                  {/* Eyebrow */}
                  <div className="flex items-center gap-[8px]">
                    <div className="w-[24px] h-px bg-[#00838F]" />
                    <span
                ...
                <div className="flex items-center justify-between mt-[40px]">
                  <span
                    className="font-['Inter'] font-semibold text-white group-hover:text-[#00838F] transition-colors"
                    style={{ fontSize: "15px", letterSpacing: "-0.3px" }}
                  >
                    Browse All Articles
                  </span>
                  <div className="w-[48px] h-[48px] bg-[#00838F] rounded-full flex items-center justify-center text-white group-hover:bg-white group-hover:text-[#00838F] transition-colors shrink-0">
                    <ArrowIcon />
                  </div>
                </div>
