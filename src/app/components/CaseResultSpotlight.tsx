...
export function CaseResultSpotlight() {
  ...
  return (
    <section className="py-[120px] bg-[#F7F7F7] overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 md:px-10">
        <div className="flex items-end justify-between mb-16">
          <div className="flex flex-col gap-[22px] max-w-[550px]">
            <div className="flex items-center gap-[10px]">
              <div className="bg-[#00838F] h-px w-[35px]" />
              <span className="font-['Inter'] font-medium uppercase text-[#00838F] text-[14px] tracking-widest">
                Proven Performance
              </span>
            </div>
            <h2 className="font-['Inter'] font-bold text-[#2C3E50] text-[48px] leading-[1.08]" style={{ textWrap: 'balance', letterSpacing: "-1.5px" }}>
              Real cases. <span className="text-[#00838F]">Real savings.</span>
            </h2>
          </div>
          <Link
            to="/about"
            className="bg-[#2C3E50] text-white inline-flex items-center gap-3 px-8 py-4 rounded-full transition-all hover:bg-[#00838F]"
          >
        ...
        <div className="relative -mx-6 md:-mx-10 px-6 md:px-10">
          <div className="overflow-hidden">
            ...
            >
              {carouselItems.map((item, idx) => (
                <div
                  key={idx}
                  className="w-[420px] rounded-xl overflow-hidden flex flex-col group cursor-pointer shrink-0 border border-[rgba(0,0,0,0.05)] shadow-sm bg-white"
                >
                  {/* Image Section */}
                  <div className="h-[260px] overflow-hidden relative">
                    ...
                    />
                    <div className="absolute top-4 right-4 bg-[#00838F] text-white px-3 py-1 rounded-full text-xs font-bold font-['Inter']">
                      {item.saved} Saved
                    </div>
                    <motion.div
                      animate={{ x: ["-100%", "200%"] }}
                  ...
                  <div className="flex flex-col gap-6 p-8 grow justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-xs font-bold uppercase tracking-widest text-[#2C3E50]/40">
                          {item.title}
                        </span>
                      </div>

                      <p className="font-['Inter'] text-[16px] leading-relaxed line-clamp-3 mb-6 text-[#636363]">
                        {item.situation}
                      </p>
                    </div>
                    ...
                    <div className="pt-6 border-t border-[rgba(0,0,0,0.1)]">
                      <div className="flex justify-between items-end">
                        <div className="flex flex-col gap-1">
                          <span className="text-[10px] font-bold uppercase tracking-widest text-[#636363]/60">Settled For</span>
                          <span className="text-[32px] font-bold text-[#00838F] leading-none">{item.settled}</span>
                        </div>
                        <div className="flex flex-col items-end gap-1">
                          <span className="text-[10px] font-bold uppercase tracking-widest text-[#636363]/60">Total Debt</span>
                          <span className="text-[18px] font-medium line-through leading-none text-[#636363]/40">{item.owed}</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-[#F7F7F7] to-transparent z-10 pointer-events-none" />
          <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-[#F7F7F7] to-transparent z-10 pointer-events-none" />
        </div>

        <p className="text-center font-['Inter'] text-[13px] text-[#636363]/50 mt-12 italic">
