    ...
    <footer className="bg-[#0f0f0f] text-white overflow-hidden">
      ...
      <div className="max-w-[1330px] mx-auto px-[70px]">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1px_auto_1px_auto_1px_1fr] pt-[72px] pb-[64px]">
          ...
          <div className="flex flex-col justify-between pr-12 pb-10 lg:pb-0">
            <div>
              ...
              <p className="font-['Inter'] text-white/40 text-[14px] leading-[1.7] max-w-[240px]" style={{ letterSpacing: "-0.2px" }}>
            ...
            <div className="flex items-center gap-3 mt-10">
              {SOCIALS.map(({ icon: Icon, href, label }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-10 h-10 rounded-lg border border-white/10 flex items-center justify-center text-white/40 hover:border-white/30 hover:text-white transition-all duration-200"
                >
            ...
            <ul className="flex flex-col gap-[18px]">
              {NAV_COL_1.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.href}
                    className="font-['Inter'] font-medium text-[13px] uppercase tracking-[0.08em] text-white/40 hover:text-white transition-colors duration-200"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div className="flex flex-col justify-between pl-12 pt-2 pb-2">
            <div>
              <p
                className="font-['Inter'] font-light text-white/60 leading-[1.5] mb-8"
              ...
              <a
                ...
                className="block font-['Inter'] font-medium text-white/70 hover:text-white transition-colors mb-3 border-b border-white/20 pb-1 w-fit"
              ...
              <a
                ...
                className="block font-['Inter'] font-medium text-white/70 hover:text-white transition-colors border-b border-white/20 pb-1 w-fit"
                style={{ fontSize: "16px", letterSpacing: "-0.3px" }}
              >
                info@sympletax.com
              </a>
        ...
        <div className="border-t border-white/[0.06] py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-['Inter'] text-white/25 text-[12px]" style={{ letterSpacing: "-0.1px" }}>
            © {new Date().getFullYear()} SympleTax. All Rights Reserved.
          </p>
          <div className="flex items-center gap-6">
            {["Privacy Policy", "Terms of Service", "Disclaimer"].map((label) => (
              <a key={label} href="#" className="font-['Inter'] text-white/25 text-[12px] hover:text-white/60 transition-colors" style={{ letterSpacing: "-0.1px" }}>
                {label}
              </a>
            ))}
          </div>
