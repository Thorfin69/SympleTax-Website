        ...
        <div className="flex items-stretch gap-[80px]">
          ...
          >
            ...
            {MAP_AVATARS.map((avatar, idx) => (
              <motion.div
                ...
                className="w-[52px] h-[52px] rounded-full overflow-hidden border-2 border-white shadow-[0px_4px_14px_rgba(0,0,0,0.15)]"
              >
          ...
          >
            ...
            <div className="flex flex-col gap-[22px]">
              ...
              >
                Our Valued Clients{" "}
                <span className="text-[#017984]">Trust Our Results</span>
              </h2>
              <p
            ...
            <div className="grid grid-cols-2 gap-x-[60px] gap-y-[30px]">
              {[
                ...
                >
                  <span
                    className="font-['Inter'] font-bold text-[#2c3e50] leading-[1.1]"
